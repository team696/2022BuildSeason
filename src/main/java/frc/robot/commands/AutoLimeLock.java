...
public class AutoLimeLock extends CommandBase {
     ...
     * Driver control
     */
    public AutoLimeLock(Swerve s_Swerve,  /* Joystick controller,  int translationAxis, int strafeAxis, int rotationAxis */ boolean fieldRelative, boolean openLoop) {
    ...
    public void execute() {
        double yAxis = 0;
        double xAxis = 0;
        double rAxis = -s_Swerve.limelightOffset();
