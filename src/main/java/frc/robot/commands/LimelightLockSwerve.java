...
public class LimelightLockSwerve extends CommandBase {
     ...
     * Driver control
     */
    public LimelightLockSwerve(Swerve s_Swerve, Joystick controller, int translationAxis, int strafeAxis, int rotationAxis, boolean fieldRelative, boolean openLoop) {
    ...
    public void execute() {
        ...
        double rAxis = -s_Swerve.joyControlUntilLock(controller.getRawAxis(rotationAxis));
